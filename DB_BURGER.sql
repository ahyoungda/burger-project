...
insert into customer values (null, '박성은', '2024.06.26', 'GOLD', 01000004321);
insert into customer values (null, '홍주연', '2024.06.26', 'SILVER', 01043210000);
...
insert into customer values (null, '김강현', '2024.06.27', 'BRONZE', 01011112222);
insert into customer values (null, '강연진', '2024.06.26', 'BRONZE', 01022221111);
insert into customer values (null, '권은혜', '2024.06.26', 'IRON', 01033332222);
insert into customer values (null, '배하은', '2024.06.26', 'BRONZE', 01022223333);
